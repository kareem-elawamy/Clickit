...
class ConfigController extends Controller
{
    ...
    public function configuration(): JsonResponse
    {
        ...
        return [
            ...
            'terms_&_conditions' => getWebConfig(name: 'terms_and_conditions') ?? "",
            'refund_policy' => getWebConfig(name: 'refund_policy') ?? "",
            'return_policy' => getWebConfig(name: 'return_policy') ?? "",
            'cancellation_policy' => getWebConfig(name: 'cancellation_policy') ?? "",
            'shipping_policy' => getWebConfig(name: 'shipping_policy') ?? "",
